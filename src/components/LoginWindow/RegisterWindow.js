    ...
    return (props.trigger)?(
        <div class="fixed flex w-screen h-screen justify-center items-center bg-gray-700/75" >
            <div class="relative flex p-0 m-0 w-[350px] h-[400px] bg-gray-500 shadow-2xl shadow-gray-400 rounded-lg">
                ...
                <div id="registerForm" class="flex flex-col w-full mx-20 my-10 text-gray-200 text-sm">
                    <label class="flex text-xl mb-5">Register below</label>
                    ...
                    <form>
                        ...
                        <button id="registerButton" type="button" onClick={() => registerNewUser(props)} class="flex bg-gray-600 px-2 py-1 mt-5 rounded-lg text-sm border-4 border-gray-800 hover:bg-gray-800">submit</button>
                    </form>
                </div>
            </div>
        </div>
